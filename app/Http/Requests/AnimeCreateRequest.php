...
class AnimeCreateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'title.unique' => 'Такое название релиза уже существует',
            'original_title.required' => 'Введите оригинальное название',
            'original_title.unique' => 'Такое оригинальное название уже существует',
    ...
    {
        return [
            'title' => ['required', 'unique:anime'],
            'original_title' => ['required', 'unique:anime,original_title'],
