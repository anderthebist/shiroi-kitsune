    ...
    <section class="content admin_content pb-3">
        <div class="container-fluid">
            <div class="card card-primary">
                <form method="POST" action = "{{ route("relizes.update", ['relize'=> $relize]) }}" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="card-body" style="background: rgb(24, 24, 24);">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group @error('image') is-invalid @enderror">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="image_input">{{ $relize->image }}</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name = "poster" class="custom-file-input" id="poster_input" multiple>
                                <label class="custom-file-label" for="poster_input">
                                    @if ($relize->poster)
                                        {{ $relize->poster }}
                                    @else
                                        Выберите файл
